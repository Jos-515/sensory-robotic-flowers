...
#Get the data from the arduino into this python program
...
# Function to resize and save images as new files
def resize_and_save(original_path, output_path, size=(150, 100)):
    img = Image.open(original_path)
    img = img.resize(size)
    img.save(output_path)

resize_and_save("bin/button2.gif", "bin/moisture_resized.gif")
resize_and_save("bin/button3.gif", "bin/light_resized.gif")
resize_and_save("bin/button1.gif", "bin/air_resized.gif")
resize_and_save("bin/button4.gif", "bin/temperature_resized.gif")
...
#MOISTURE BOXES POTENTIOMETER PROGRESS

#from 

#def moistureProgress()

#moisture_boxes[15].bg = "#694D40"
#moisture_boxes[14].bg = "#694D40"
#moisture_boxes[13].bg = "#694D40"
#moisture_boxes[12].bg = "#694D40"
#moisture_boxes[11].bg = "#694D40"
#moisture_boxes[10].bg = "#694D40"
#moisture_boxes[9].bg = "#694D40"
#moisture_boxes[8].bg = "#694D40"
#moisture_boxes[7].bg = "#694D40"
#moisture_boxes[6].bg = "#694D40"
#moisture_boxes[5].bg = "#694D40"
#moisture_boxes[4].bg = "#694D40"
#moisture_boxes[3].bg = "#694D40"
#moisture_boxes[2].bg = "#694D40"
#moisture_boxes[1].bg = "#694D40"
